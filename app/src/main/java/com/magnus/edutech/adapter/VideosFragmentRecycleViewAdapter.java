package com.magnus.edutech.adapter;
...
import com.magnus.edutech.ActivityMain;
import com.magnus.edutech.ActivityPriceList;
import com.magnus.edutech.ActivityShowVideosFromVimeo;
import com.magnus.edutech.ActivityVideo;
...
public class VideosFragmentRecycleViewAdapter extends RecyclerView.Adapter<VideosFragmentRecycleViewAdapter.ViewHolder> {
    ...
    ActivityMain gridVideoActivity;
    ...
    public VideosFragmentRecycleViewAdapter(Context ctx, List<Videos> ListOfVideos) {
        ...
        gridVideoActivity = (ActivityMain) context;
        ...
        viewHolder.imageViewVideoPlay.setOnClickListener(new View.OnClickListener() {
...

            {
                ...
                if (videos.isPurchased()) {
                    ...
                    Intent intent = new Intent(context, ActivityPriceList.class);
