package com.magnus.edutech.webservices.lectureservices.servercall.impl;
 ...
 */
public class MakeALectureServerCallImpl implements MakeALectureServerCall {
    ...
    public MakeALectureServerCallImpl(RequestCallbackListener ev) {
    ...
    public void serverCallSubjects(Context context, Course course) {
        try {
            getLecturesRequestParam = requestParameter.getLectureRequestParamObject();
    ...
    public void serverCallSubjectsResponse(String response) {
        ...
        LectureJsonParser lectureJsonParser = jsonParser.getLectureParserObject();
