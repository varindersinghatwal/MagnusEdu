...
import com.magnus.edutech.adapter.NavDrawerListAdapter;
...
public class ActivityMain extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        boolean isPurchased = GlobalConstants.get_Preferences_boolean(GlobalConstants.PURCHASED, context);
        if(!isPurchased)
        {
    ...
    private void logoutFromApp() {
        GlobalConstants.save_Preferences(GlobalConstants.CLIENT_ID, "", this);
        GlobalConstants.save_Preferences_boolean(GlobalConstants.LOGGED_IN, false, this);
